...
def args_parser():
    ...
    # === NEW v7: Distribution-Aware Mixup ===
    parser.add_argument('--use_dist_aware_mixup', action='store_true', help="Whether to use distribution-aware mixup for non-IID")
    parser.add_argument('--mixup_alpha', type=float, default=1.0, help="Alpha parameter for Beta distribution in mixup")
