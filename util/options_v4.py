...
def args_parser():
    ...
    # other arguments
    # parser.add_argument('--model', type=str, default='resnet18_fd', help="model name")
    parser.add_argument('--model', type=str, default='resnet18', help="model name")
    parser.add_argument('--dataset', type=str, default='cifar10', help="name of dataset")
    parser.add_argument('--pretrained', action='store_true', help="whether to use pre-trained model")
    # parser.add_argument('--noniid', action='store_true', help="i.i.d. or non-i.i.d.") # default=False
