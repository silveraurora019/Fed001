...
def args_parser():
    ...
    parser.add_argument('--frac1', type=float, default=0.2, help="fration of selected clients in preprocessing stage")
    ...
    # === v222: a fair prototype clustering method ===
    ...
    # === v1: FedLabel inspired pseudo-labeling ===
    parser.add_argument('--beta_pseudo', type=float, default=0.5, help="Confidence threshold for pseudo-labeling in FedLabel")
