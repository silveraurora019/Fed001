...
def build_model(args):
    ...
    elif args.model == 'resnet18_fd': # Add option for FDConv ResNet
        netglob = ResNet18_FD(args.num_classes)
        netglob = netglob.to(args.device)
